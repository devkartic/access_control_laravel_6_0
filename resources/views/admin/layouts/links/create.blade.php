<div class="col-12">
    <form method="POST" action="{{ url('links') }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-7">
                <input id="order_number" type="text" class="form-control @error('order_number') is-invalid @enderror" name="order_number" value="{{ old('order_number') }}" required autocomplete="order_number" autofocus>
